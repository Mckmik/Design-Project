...
?>
    ...
    <div id="first">    
        <h1>Add Hours </h1>
        <h3>For <?php echo date("m/d/Y",$start).' - '.date("m/d/Y",$end); ?></h3>
        <a href="user_manual.pdf#page=57" target="_blank" style="float: right; padding: 0 100px;">Help <i class="fa fa-question fa-lg"></i></a><br>

        <form action="add_timesheet_line.php?timesheet_id=<?php echo $timesheetId.$admin_view;?>" method="POST">
        ...
        <div id="date" style="display: none;">
            <form action="add_timesheet_line.php?timesheet_id=<?php echo $timesheetId.$admin_view;?>" method="POST">
            <p><label>Date Worked:</label><br><input type="text" name="date_worked" id="datepicker" required readonly><input type="text" id="dateH" style="display: none;" required></p>
            <p>
